...
?>
    <div class="row vh-100 w-100">
        <form action="accion/accionBuscarAutosPersona.php" method="post" class="d-flex justify-content-center align-items-center needs-validation">
            <div class="d-flex row align-items-lg-end flex-column bg-dark p-4 rounded w-50">
                <div class="form-group text-center">
                    ...
                    <div class="input-group-text" id="input-dni-duenio">
                        ...
                        <input type="text" maxlength="8" class="form-control" id="dni-duenio" name="dni-duenio" placeholder="Ejemplo: 44041670" required pattern="[0-9]+" errorVacio="Este campo no puede estar vacío" errorPatron="El campo solo acepta caracteres numéricos">
                    </div>
