                ...
                <div class="d-flex align-items-lg-center flex-column bg-dark p-4 rounded w-50 m-auto">
                    <div class="form-group w-75">
                        ...
                        <div class="input-group-text" id="input-dni-modificar">
                            <i class="fa fa-user px-3 col-1"></i>
                            <input type="text" class="form-control" maxlength="8" id="dni-modificar" name="dni-modificar" placeholder="Ejemplo: 44041670" required pattern="[0-9]{8}" errorVacio="Este campo no puede estar vacío" errorPatron="El dni debe estar conformado de 8 números.">
                        </div>
