    ...
    <div class="bg-dark p-5 rounded-5 col-12 col-md-10 col-xl-8">
      <form action="Accion/agregarProducto.php" id="form" method="POST" class="col-12 needs-validation p-4 rounded-5 gap-3" novalidate enctype="multipart/form-data">
        ...
        <div class="input-group mb-3">
          <span class="input-group-text bg-info fw-bold border-0" id="basic-addon1">Nombre</span>
        ...
        <div class="input-group mb-3">
          <span class="input-group-text  bg-info fw-bold  border-0" id="basic-addon2">Detalles</span>
          <textarea type="text" class="form-control" name="prodetalle" id="prodetalle" required placeholder="Detalles del producto" aria-describedby="basic-addon2" style="resize: none;"></textarea>
          <div class="invalid-feedback">
            Debe ingresar un detalle para el producto
          </div>
        </div>
        <div class="input-group mb-3">
          <span class="input-group-text  bg-info fw-bold  border-0" id="basic-addon3">Cantidad de stock</span>
        ...
        <div class="input-group mb-3">
          <span class="input-group-text  bg-info fw-bold  border-0" id="basic-addon4">Precio</span>
          <input type="number" class="form-control" name="proprecio" id="proprecio" required placeholder="Precio del producto en dolares" aria-describedby="basic-addon4">
          <div class="invalid-feedback">
            Debe ingresar un precio válido
          </div>
        </div>
        <div class="input-group mb-3">
          <span class="input-group-text  bg-info fw-bold  border-0" id="basic-addon4">Imagen</span>
          <input type="file" class="form-control" name="proimagen" id="proimagen" accept=".png,.jpg" required aria-describedby="basic-addon4">
          <div class="invalid-feedback">
