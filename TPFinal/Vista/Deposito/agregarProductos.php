...
<div class="d-flex justify-content-center align-items-center ">
  <div class="d-flex justify-content-center col-12 col-md-8 row position-relative h-100 align-items-center min-vh-100">
    <div class=" p-5 rounded-5 col-12 col-md-10 col-xl-8 bg-gris" data-bs-theme="light">
      <form action="../Accion/agregarProducto.php" id="form" method="POST" class="col-12 needs-validation p-4 rounded-5 gap-3" novalidate enctype="multipart/form-data">
        ...
        <div class="input-group mb-3">
          <span class="input-group-text fw-bold border-0" id="basic-addon1">Nombre</span>
        ...
        <div class="input-group mb-3">
          <span class="input-group-text fw-bold border-0" id="basic-addon2">Detalles</span>
        ...
        <div class="input-group mb-3">
          <span class="input-group-text fw-bold border-0" id="basic-addon3">Cantidad de stock</span>
        ...
        <div class="input-group mb-3">
          <span class="input-group-text fw-bold border-0" id="basic-addon4">Precio</span>
        ...
        <div class="input-group mb-3">
          <span class="input-group-text fw-bold border-0" id="basic-addon5">Imagen</span>
