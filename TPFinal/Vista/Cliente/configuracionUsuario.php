    ...
    <div class="col-12 col-lg-9 bg-body-tertiary h-100 min-vh-100">
        <div class="d-flex justify-content-center align-items-center min-vh-100">
            <ul class="list-group list-group w-50">
                <form id="miFormulario" class="needs-validation row" novalidate>
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                            ...
                            <input class='form-control' type='text' name='usnombre' id='usnombre' value= <?php echo "'" . $usuario->getNombre() . "'"?>>
                        </div>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                            <div class="fw-bold ">Contraseña</div>
                            <input class='form-control' type='password' name='uspass' id='uspass' value= <?php echo "'" . $usuario->getPass() . "'"?>>
                        </div>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                            <div class="fw-bold ">E-mail</div>
                            <input class='form-control' type='email' name='usmail' id='usmail' value= <?php echo "'" . $usuario->getMail() . "'"?>>
                        </div>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                        ...
                        <button type="button"  id="btndeshabilitar" class="btn btn-danger my-auto" onclick="deshabilitarUsuario()">Deshabilitar</button>
                    </li>
                    <div class="mt-4">
